...
namespace MazeSolving_Faye
{
    public class MazeController : MonoBehaviour
    {
        ...
        public void ResetArea(GameObject mazeObj, MazeBuilder mazeBuilder, GameObject endCubeObj, GameObject agentObj,
        ...
        [CanBeNull]
        private Maze GenerateMaze(GameObject mazeObj, MazeBuilder mazeBuilder, GameObject endCubeObj,
            GameObject agentObj, Vector3 mazePosition)
        {
            try
            {
